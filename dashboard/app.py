...
PAGES = {'': 'Przegląd', 'actions': 'Akcje i ślady', 'inbox': 'Skrzynka', 'radar': 'Radar', 'queue': 'Kolejka', 'wallet': 'Portfel wypłat', 'persona': 'Persona', 'settings': 'Ustawienia', 'security': 'Bezpieczeństwo', 'tuning': 'Dostrajanie', 'benefits': 'Korzyści', 'audits': 'Audyty'}
